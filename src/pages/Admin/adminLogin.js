...
function AdminLogin() {
    ...
    const handleChangePassword = async () => {
        try {
            await axios.patch("http://localhost:5000/api/password/", passwordData).
                then((response) => {
    ...
    const handleFormSubmission = () => {
        ...
        const res = axios.post('http://localhost:5000/api/auth/loginAdmin',
            formState)
            .then((response) => {
                ...
                <div className="col-12 col-sm-5">
                    ...
                    <form>
                        ...
                        <div className="mt-4" style={{ width: '70%', margin: 'auto' }}>
                            <button disabled={loadingState} variant="contained" onClick={handleFormSubmission} color="primary" style={{ margin: "auto" }} type="submit" className="btn btn-primary btn-lg btn-block" style={{ width: '100%', margin: 'auto' }}>Sign in</button>
                        </div>
                    </form>
